...
namespace FirmaAPP
{
    public partial class frmOrderTshirtsSalesList : Form, IOrderTshirtsSalesListView
    {

        #region private members
        private OrderTshirtsSalesListPresenter _presenter;
        private frmMainForm _mainForm;
        #endregion
        #region Constructor
        public frmOrderTshirtsSalesList()
        {
            InitializeComponent();
        }
        #endregion
        ...
        public void AttachPresenter(OrderTshirtsSalesListPresenter presenter)
        {
        ...
        #endregion
        #region Events
        private void frmOrderSalesList_Load(object sender, EventArgs e)
        {
            AppContext.ActiveForms.Add(this);
            _presenter.Init();
        }
        private void frmOrderSalesList_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void btnAddSale_Click(object sender, EventArgs e)
        {
            try
            {
                frmOrderTshirtSalesDetails childForm = new frmOrderTshirtSalesDetails();
                OrderTshirtSalesDetailsPresenter presenter = new OrderTshirtSalesDetailsPresenter(childForm);
        ...
        {
            if (e.RowIndex >= 0)
                editSaleTshirtOrder((Order)dataGridSalesList.Rows[e.RowIndex].DataBoundItem);
        }
        ...
        private void editSaleTshirtOrder(Order order)
        {
