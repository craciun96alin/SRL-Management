namespace FirmaAPP
{
    partial class frmProviderDetails
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmProviderDetails));
            ...
            this.panelFilamentInformations.Controls.Add(this.tbIBAN);
            this.panelFilamentInformations.Controls.Add(this.label9);
            this.panelFilamentInformations.Controls.Add(this.tbPhone);
            this.panelFilamentInformations.Controls.Add(this.label8);
            this.panelFilamentInformations.Controls.Add(this.label7);
            this.panelFilamentInformations.Controls.Add(this.rbTVAno);
            this.panelFilamentInformations.Controls.Add(this.rbTVAyes);
            this.panelFilamentInformations.Controls.Add(this.tbCUI);
            this.panelFilamentInformations.Controls.Add(this.label6);
            this.panelFilamentInformations.Controls.Add(this.tbAdress);
            this.panelFilamentInformations.Controls.Add(this.label5);
            this.panelFilamentInformations.Controls.Add(this.tbCity);
            this.panelFilamentInformations.Controls.Add(this.label4);
            this.panelFilamentInformations.Controls.Add(this.tbCounty);
            this.panelFilamentInformations.Controls.Add(this.label3);
            this.panelFilamentInformations.Controls.Add(this.tbCountry);
            this.panelFilamentInformations.Controls.Add(this.label2);
            ...
            this.Name = "frmProviderDetails";
            this.Load += new System.EventHandler(this.frmProviderDetails_Load);
