...
namespace FirmaAPP.DataAccess.Migrations
{
    ...
    [Migration("20210108222342_CreateAttributes")]
    partial class CreateAttributes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FirmaAPP.BusinessObject.AppSettings", b =>
                {
                    ...
                    b.Property<string>("_3DDesignFolder")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("_3DPrintFolder")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FirmaAPP.BusinessObject.AttributeColors", b =>
                {
                    ...
                    b.HasKey("AttributeColorsID");

                    b.ToTable("AttributeColors");
                });
            ...
            modelBuilder.Entity("FirmaAPP.BusinessObject.BusinessDetails", b =>
                {
                    ...
                    b.Property<float>("DigitalMoney")
                        .HasColumnType("real");

                    b.Property<float>("ExtraMoney")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("FirmaAPP.BusinessObject.BusinessDetails", b =>
                {
                    b.HasOne("FirmaAPP.BusinessObject.User", "_user")
                        ...
                        .HasForeignKey("FirmaAPP.BusinessObject.BusinessDetails", "UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FirmaAPP.BusinessObject.Filament", b =>
                {
                    b.HasOne("FirmaAPP.BusinessObject.AttributeColors", "Color")
                        .WithMany("Filaments")
                        .HasForeignKey("AttributeColorsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FirmaAPP.BusinessObject.AttributeFilamentsType", "Type")
                        .WithMany("Filaments")
            ...
            modelBuilder.Entity("FirmaAPP.BusinessObject.Tshirt", b =>
                {
                    ...
                    b.HasOne("FirmaAPP.BusinessObject.AttributeTshirtsType", "Type")
                        .WithMany("Tshirts")
            ...
            modelBuilder.Entity("FirmaAPP.BusinessObject.Vinyl", b =>
                {
                    ...
                    b.HasOne("FirmaAPP.BusinessObject.AttributeVinylsType", "Type")
                        .WithMany("Vinyls")
